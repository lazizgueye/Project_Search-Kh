...
function afficherPanier(){
	if(panier.length != 0){
		...
		for(var i=0; i<panier.length; i++){
			panier_totalPrix += (parseFloat(panier[i].prix) * parseInt(panier[i].quantite));
		}
		
		pageHtml += '<div class="row"><div class="col-sm-6 text-center"><h2><b>TOTAL: '+panier_totalPrix+' €</b></h2></div>';
...
function validerEcran2(){
	...
	$(".totalCommande").html("TOTAL de la commande = "+panier_totalPrix+" euro TTC");
}
